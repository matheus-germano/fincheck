  ...
  return (
    <div className="relative">
      <input
        {...props}
        id={inputId}
        className="peer h-[52px] w-full bg-white rounded-lg border border-gray-500 px-3 text-gray-800 pt-4 placeholder-shown:pt-0 focus:border-gray-800 transition-all outline-none"
        placeholder=" "
      />
      <label
        htmlFor={inputId}
