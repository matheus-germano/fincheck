    ...
    return (
      <div className="relative">
        <input
          ...
          id={inputId}
          className={cn(
            'peer h-[52px] w-full bg-white rounded-lg border border-gray-500 px-3 text-gray-800 pt-4 placeholder-shown:pt-0 focus:border-gray-800 transition-all outline-none',
